...
def get_posts():
    access_token = 'b81336aa4755975fb08b16421221fc8272a82a290f5551e0a2a91e866bd7130d7d9b82d76b97272868647'
    count = 100 #до 200
...
info = Counter(date) #Получаю дату/координату и сколько раз она повторяется
info = list(info.items())
info.sort(key=itemgetter(0)) #Сортирую от первой даты/координаты до последней
key = []
values =[]
for i in info:
    key.append((i[0]))
    values.append(i[1]) #Кортеж из списка дат/координат и списка повторений
