...
INSTAGRAM_ACCESS_TOKEN = '327687327.98332a7.607e2d45d68c419eb70fcc8d6eb4b32e'
DISTANCE = '100'
...
def getInstagram(latitude, longitude, distance, minTimestamp, maxTimestamp):
    ...
    return getResponse("https://api.instagram.com/v1/media/search", params=params, verify=True).json()
